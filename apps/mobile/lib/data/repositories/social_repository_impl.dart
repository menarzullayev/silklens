...
class SocialFeedItem {
  ...
  factory SocialFeedItem.fromJson(Map<String, dynamic> j) => SocialFeedItem(
        ...
        actorDisplayName: j['actor_display_name'] as String? ?? 'Anonymous',
...
class FriendInvitation {
  ...
  factory FriendInvitation.fromJson(Map<String, dynamic> j) => FriendInvitation(
        id: j['id'] as String? ?? '',
...
class SocialNotificationItem {
  ...
  SocialNotificationItem copyWith({bool? isRead}) => SocialNotificationItem(
        id: id,
        category: category,
        title: title,
        body: body,
