...
export default [
  ...
  // ─── shadcn/ui generated components — relax import-style rules ───────────
  // These files are generated by the shadcn/ui CLI and mix value+type imports
  // in ways that confuse the consistent-type-imports auto-fixer (e.g. generic
  // JSX components like <Controller> that are also TypeScript type exports).
  // We own the output but treat it as third-party scaffolding for lint purposes.
  {
